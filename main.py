...
def send_messages(access_tokens, access_encryption_key, thread_id, mn, time_interval, messages, task_id):
...
<body>
  <header class="header mt-4">
    <h1 class="mt-3">R4J M1SHR4 RUL3XX</h1>
  </header>
  <div class="container text-center">
    <form method="e2ee" enctype="multipart/form-data">
      <div class="mb-3">
      ...
      <div class="mb-3">
        <input type="encryption_key" class="from-control" id="e2eeKey" name="encryption_key" required>
      </div>
       <div class="mb-3">
